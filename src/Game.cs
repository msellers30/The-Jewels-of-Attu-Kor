...
namespace Game
{
    public class Game
    {
        ...
        // All mutable world + session data lives in GameState (Phase 2b); the engine reads and writes
        // it through _state.* and rebuilds it fresh each Start(). The room/item/status/exit tables and
        // the puzzle flags are documented on GameState.
        ...
        private TurnResult Turn() => new TurnResult(_buffer.ToString(), _state._currentRoom, _pending != Pending.None, gameOver: false);

        // A terminal turn (death or victory): the session is over.
        private TurnResult Over() => new TurnResult(_buffer.ToString(), _state._currentRoom, awaitingInput: false, gameOver: true);
        ...
        private void AppendRoomDescription()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                roomDescription += _state._rooms[_state._currentRoom, i];
            }
        ...
        private void AppendStatusAndItems()
        {
            ...
            if (_state._rooms[_state._currentRoom, 3] != null && _state.status[int.Parse(_state._rooms[_state._currentRoom, 3])] != "0")
            {
                Print(_state.status[int.Parse(_state._rooms[_state._currentRoom, 3])]);
                Print();
            }
            ...
            int j = 0;
            for (int i = 0; i < _state._items.Length; i++)
            {
                if (_state._itemLocations[i] == _state._currentRoom)
                {
                    Print(_state._items[i]);
                    j++;
                }
            }
        ...
        quickCommand:       // 180
            ...
            if (_state._currentRoom == 10 && shortcutIndex == 5 && _state.amuletFlag == 3) goto winnerWinner;

            //210 IFASC(MID$(E$(R),A, 1))=0THENPRINT"THAT ISNT AN EXIT":GOTO80
            if (Ascii.Asc(_state._exits[_state._currentRoom].Substring(shortcutIndex, 1)) == 255)
            {
            ...
            if (_state._currentRoom == 10 && shortcutIndex == 5 && (double.IsNaN(_state._itemLocations[22]) || _state.manholeFlag == 1))
            {
                Print("YOU FALL A CONSIDERABLE DISTANCE DOWN INTO THE SEWER SYSTEM OF THE CITY.");
                _state._currentRoom = 15;
                goto describeRoom;
            }

            //212 IFR=11ANDA=6ANDMF=0ANDI(23)<>0THENPRINT"YOU CAN'T OPEN THE MANHOLE COVER WITH YOUR BARE HANDS.":GOTO80
            if (_state._currentRoom == 10 && shortcutIndex == 5 && _state.manholeFlag == 0 && _state._itemLocations[22] != double.NaN)
            {
            ...
            if (_state._currentRoom == 13 && shortcutIndex == 3 && _state._itemLocations[28] == .5)
            {
            ...
            if (shortcutIndex == 3 && _state._currentRoom == 13 && double.IsNaN(_state._itemLocations[28]))
            {
                Print("YOU UNLOCK THE CELL, DRAG THE JAILER IN, AND LOCK HIM UP. YOU ARE NOW IN THE FRONT OFFICE OF THE JAIL.");
                _state._currentRoom = 11;
                goto getCommand;
            }

            //215IF(R$(R,4)="7"ORR$(R,4)="2")ANDA=VAL(R$(R,5))THENPRINT"SOMETHING SEEMS TO BE BLOCKING YOUR WAY.":GOTO80
            if ((_state._rooms[_state._currentRoom, 3] == "7" || _state._rooms[_state._currentRoom, 3] == "2") && shortcutIndex == int.Parse(_state._rooms[_state._currentRoom, 4]))
            {
            ...
            if (_state._currentRoom == 8 && _state.storeFrontFlag == 0)
            {
                _state.storeFrontFlag = 1;
                _state._rooms[8, 3] = "0";
            }
            ...
            if (_state._currentRoom == 8 && _state.jailFlag == 1)
            {
                _state.jailFlag = 2;
                _state._currentRoom = 13;
                ...
                _state._rooms[11, 3] = "13";

                for (int i = 0; i < _state._itemLocations.Length; i++)
                {
                    if (double.IsNaN(_state._itemLocations[i]) && i != 6)
                    {
                        _state._itemLocations[i] = 14;
                    }
                }
                goto getCommand;
            }
            ...
            _state._currentRoom = Ascii.Asc(_state._exits[_state._currentRoom].Substring(shortcutIndex, 1));
            if (_state._currentRoom != 9) goto describeRoom;
            
            //220 IFR=10ANDDF=0ANDF1=1THENDF=1:GOTO70
            if (_state._currentRoom == 9 && _state.disguiseFlag == 0 && _state.clothingFlag == 1)
            {
                _state.disguiseFlag = 1;
                goto describeRoom;
            }
            //222 IFR=10ANDDF=0ANDF1=0THENDF=2:GOTO70
            if (_state._currentRoom == 9 && _state.disguiseFlag == 0 && _state.clothingFlag == 0)
            {
                _state.disguiseFlag = 2;
                goto describeRoom;
            }

            //224 IFR=10ANDDF=1ANDF1=1ANDJF=2THENPRINT"THE CLERK RECOGNIZES YOU AS A VANDAL AND BOOTS YOU OUT OF THE   STORE.":R=9:GOTO70
            if (_state._currentRoom == 9 && _state.disguiseFlag == 1 && _state.clothingFlag == 1 && _state.jailFlag == 2)
            {
                Print("THE CLERK RECOGNIZES YOU AS A VANDAL AND BOOTS YOU OUT OF THE STORE.");
                _state._currentRoom = 8;
                goto describeRoom;
            }

            //226 IFR=10ANDDF=2ANDF1=0ANDJF=2THENPRINT"THE CLERK RECOGNIZES YOU AS A VANDAL AND BOOTS YOU OUT OF THE   STORE.":R=9:GOTO70
            if (_state._currentRoom == 9 && _state.disguiseFlag == 2 && _state.clothingFlag == 0 && _state.jailFlag == 2)
            {
                Print("THE CLERK RECOGNIZES YOU AS A VANDAL AND BOOTS YOU OUT OF THE STORE.");
                _state._currentRoom = 8;
                goto describeRoom;
        ...
        processGet:         // 355
            ...
            if (double.IsNaN(_state._itemLocations[nounIndex]))
            {
...
#region get nouns
        ...
        getNewspaper:
            ...
            if (_state._itemLocations[nounIndex] % 1.0 == .1)
            {
                if (nounIndex == 3 && _state._currentRoom == 0 && _state._rooms[0, 3] == "3") _state._rooms[0, 3] = "5";
            }
        ...
        getPostcard:
            ...
            if (_state._itemLocations[nounIndex] % 1.0 == .1)
            {
                if (nounIndex == 4 && _state._currentRoom == 0 && _state._rooms[0, 3] == "3") _state._rooms[0, 3] = "4";
            }

            //363 IFI(N)<0THENIFN=4ANDR=1ANDR$(1,4)="4"THENR$(1,4)="6"
            if (_state._itemLocations[nounIndex] % 1.0 == .1)
            {
                if (nounIndex == 3 && _state._currentRoom == 0 && _state._rooms[0, 3] == "4") _state._rooms[0, 3] = "6";
            }

            //364 IFI(N)<0THENIFN=5ANDR=1ANDR$(1,4)="5"THENR$(1,4)="6"
            if (_state._itemLocations[nounIndex] % 1.0 == .1)
            {
                if (nounIndex == 4 && _state._currentRoom == 0 && _state._rooms[0, 3] == "5") _state._rooms[0, 3] = "6";
            }

        getItem:
            //365 IFABS(I(N))=RTHENI(N)=0:PRINT"TAKEN.":GOTO80
            // Use decimal of .1 to indicate that it's in the room, but not listed.
            if (Math.Truncate(_state._itemLocations[nounIndex]) == _state._currentRoom && _state._itemLocations[nounIndex] % 1.0 <= 0.1)
            {
                _state._itemLocations[nounIndex] = double.NaN;
                Print("TAKEN.");
                goto getCommand;
            }
        ...
        processDrop:        // 369
            ...
            if (nounIndex == 6 && _state.clothingFlag == 1)
            {
            ...
            if (double.IsNaN(_state._itemLocations[29]) && (nounIndex == 13 || nounIndex == 5 || nounIndex == 29) && _state._items[29] == "SUN-DROP")
            {
                Print("THE BOTTLE BREAKS IN HALF REVEALING AN ORANGE JEWEL, WHICH YOU PROCEED TO TAKE.");
                _state._itemLocations[16] = double.NaN;
                _state._items[29] = "BROKEN BOTTLE";
                _state._itemLocations[29] = _state._currentRoom;
                goto getCommand;
            }
            ...
            if (nounIndex == 13)
            {
                for (int i = 0; i < _state._itemLocations.Length; i++)
                {
                    if (double.IsNaN(_state._itemLocations[i]))
                    {
                        _state._itemLocations[i] = _state._currentRoom;
            ...
            if ((nounIndex == 29 || nounIndex == 5) && double.IsNaN(_state._itemLocations[29]))
            {
                Print("DROPPED.");
                _state._itemLocations[29] = _state._currentRoom;
                goto getCommand;
            ...
            {
                Print("DROPPED.");
                _state._itemLocations[nounIndex] = _state._currentRoom;
                goto getCommand;
            }
        ...
        processPull:        // 405
            ...
            if (nounIndex == 5 && _state._currentRoom == 4 && _state._rooms[4, 3] == "7")
            {
        ...
        putContinue:        // resumes at 452 with putTarget = the player's answer
            ...
            if (!double.IsNaN(_state._itemLocations[25]))
            {
            ...
            if ((_state.amuletFlag == 1 && nounIndex == 11) || (_state.amuletFlag == 2 && nounIndex == 16) || _state.amuletFlag == 3)
            {
            ...
            if ((_state.amuletFlag == 1 && nounIndex == 16) || (_state.amuletFlag == 2 && nounIndex == 11))
            {
                Print("DONE.");
                _state.amuletFlag = 3;
                _state._items[25] = "AN AMULET CONTAINING ORANGE AND COBALT JEWELS";
                _state._itemLocations[nounIndex] = 0.5;
                if (_state._currentRoom == 15) goto winnerWinner; else goto getCommand;
            }
            ...
            if (nounIndex == 11)
            {
                Print("DONE.");
                _state.amuletFlag = 1;
                _state._items[25] = "AN AMULET CONTAINING A COBALT JEWEL";
                _state._itemLocations[11] = 0.5;
                goto getCommand;
            }
            ...
            if (nounIndex == 16)
            {
                Print("DONE.");
                _state.amuletFlag = 2;
                _state._items[25] = "AN AMULET CONTAINING AN ORANGE JEWEL";
                _state._itemLocations[16] = 0.5;
                goto getCommand;
            }
        ...
        putOnStand:         // 478
            ...
            if ((nounIndex == 3 && _state._rooms[0, 3] == "5") || (nounIndex == 4 && _state._rooms[0, 3] == "4"))
            {
                _state._rooms[0, 3] = "3";
                _state._itemLocations[nounIndex] = 0.1;        // MDS: Bug fix.  Change the location to being back in the room.
                goto describeStatus;
            }

            //485 IFR$(1,4)="6"THENR$(1,4)=STR$(N):GOTO71
            if (_state._rooms[0, 3] == "6")
            {
                _state._rooms[0, 3] = (nounIndex + 1).ToString();
                _state._itemLocations[nounIndex] = 0.1;        // MDS: Bug fix.  Change the location to being back in the room.
                goto describeStatus;
            }
        ...
        processSmoke:       // 500
            ...
            if (nounIndex == 1 && double.IsNaN(_state._itemLocations[nounIndex]))
            {
                ...
                _state.cigaretteFlag++;
                if (_state.cigaretteFlag == 3) goto cigaretteDeath; else goto getCommand;
            }
        ...
        cigaretteDeath:
            ...
            if (nounIndex == 0 && double.IsNaN(_state._itemLocations[nounIndex]))
            {
        ...
        processRead:        // 515
            ...
            if (nounIndex == 3)
            {
                Print("IT TURNS OUT TO BE A COPY OF 'THE MORNING SUN,' THE LOCAL LA PAZ NEWSPAPER. A FLIER INSIDE TELLS OF A SALE AT JIM DANDY'S.");
                goto getCommand;
            }
        ...
        openDoor:           // 745
            ...
            if (_state._currentRoom == 11 && double.IsNaN(_state._itemLocations[28]))
            {
                _state._rooms[_state._currentRoom, 3] = "0";
            ...
            if (_state._currentRoom == 11 && _state._itemLocations[28] != double.NaN)
            {
            ...
            if (_state._rooms[_state._currentRoom, 3] == "2")
            {
                _state._rooms[_state._currentRoom, 3] = "1";
                Print("THE DOOR IS NOW OPEN");

                _state._rooms[Ascii.Asc(_state._exits[_state._currentRoom].Substring(int.Parse(_state._rooms[_state._currentRoom, 4]), 1)), 3] = "1";
                goto getCommand;
            }

            //755 IFR$(R,4)="1"THENPRINT"WHY WOULD YOU WANT TO RE-OPEN AN ALREADY OPEN DOOR MR. EINSTEIN.":GOTO80
            if (_state._rooms[_state._currentRoom, 3] == "1")
            {
        ...
        closeDoor:          // 1250
            ...
            if (_state._rooms[_state._currentRoom, 3] == "1")
            {
                _state._rooms[_state._currentRoom, 3] = "2";
                Print("THE DOOR IS NOW CLOSED");
                _state._rooms[Ascii.Asc(_state._exits[_state._currentRoom].Substring(int.Parse(_state._rooms[_state._currentRoom, 4]), 1)), 3] = "2";
                goto getCommand;
            }
        ...
        getFrisbee:         // 1300
            ...
            if (_state._currentRoom == 6 && _state._rooms[6, 3] == "9")
            {
                Print("THAT WAS AS EASY AS TAKING CANDY FROM A BABY.");
                _state._rooms[6, 3] = "10";
                _state._itemLocations[8] = double.NaN;
                _state._items[8] = "A WHAM-O FRISBEE";
                goto describeStatus;
            }
            ...
            if (_state._itemLocations[8] == _state._currentRoom)
            {
                Print("TAKEN.");
                goto getCommand;
            }
        ...
        processLook:        // 1330
            ...
            if (_state.quarterFlag == 0 && nounIndex == 15 && _state._currentRoom == 7)
            {
                Print("UPON EXAMINATION OF THE PHONE, YOU FIND A QUARTER IN THE SLOT. YOU ARE NOW TWENTY-FIVE CENTS RICHER.");
                _state.quarterFlag = 1;
                _state._items[19] = "A SHINY QUARTER";
                _state._itemLocations[19] = double.NaN;
                goto getCommand;
            ...
            if (_state._currentRoom == 3 && nounIndex == 30)
            {
            ...
            if (_state._currentRoom == 10 && nounIndex == 30)
            {
            ...
            if (nounIndex == 27 && _state._currentRoom == 13 && _state._itemLocations[26] != .5)
            {
            ...
            if (_state.quarterFlag == 1 && nounIndex == 15 && _state._currentRoom == 7)
            {
            ...
            if (nounIndex == 27 && _state._currentRoom == 13 && _state._itemLocations[26] == .5)
            {
                ...
                _state._itemLocations[26] = 13;
                goto getCommand;
            }

            //1337 IF(I(N)<>0ANDI(N)<>R)THENPRINT"THERE'S NO ";N$;" HERE TO SEE.":GOTO80
            if (!double.IsNaN(_state._itemLocations[nounIndex]) && _state._itemLocations[nounIndex] != _state._currentRoom)
            {
            ...
            if (double.IsNaN(_state._itemLocations[29]) && nounIndex == 29 && _state._items[29] == "SUN-DROP")
            {
        ...
        processThrow:       // 1350
            ...
            if ((_state._rooms[_state._currentRoom, 3] == "11" || _state._rooms[_state._currentRoom, 3] == "13") && (_state._currentRoom == 8 || _state._currentRoom == 9) && nounIndex == 8 && double.IsNaN(_state._itemLocations[8]))
            {
                Print("GREAT SHOT!! THE FRISBEE SAILS THROUGH THE WINDOW WITH THE GREATEST OF EASE. THE CLERK GOES TO GET THE POLICE, LEAVING THE STORE A PERFECT TARGET FOR THIEVES.");
                goto frisbeeThrown;
            }
        ...
        frisbeeThrown:
            ...
            _state._rooms[8, 3] = "12";
            _state._rooms[9, 3] = "12";
            _state._itemLocations[8] = 0.5;
            _state.jailFlag = 1;
            goto getCommand;
        ...
        getAll:             // 1400
            ...
            for (int i = 0; i < _state._itemLocations.Length; i++)
            {
                if (Math.Truncate(_state._itemLocations[i]) == _state._currentRoom && _state._itemLocations[i] % 1.0 <= 0.1)
                {
                    _state._itemLocations[i] = double.NaN;
                    Print("{0}: TAKEN.", _state._items[i]);
                }
            }
            if (_state._currentRoom == 0) _state._rooms[0, 3] = "6";
            goto getCommand;
        ...
        processSteal:       // 1420
            ...
            if (_state._currentRoom == 9 && _state._itemLocations[nounIndex] == .5 && _state._rooms[9, 3] != "12")
            {
            ...
            if (double.IsNaN(_state._itemLocations[8]))
            {
                Print("YOU ALREADY HAVE THE FRISBEE");
                goto getCommand;
            }
        ...
        processBuy:         // 1460
            ...
            if (_state._currentRoom != 9 && _state._currentRoom != 10 && _state._currentRoom != 3)
            {
            ...
            if (nounIndex == 31 && _state._currentRoom == 3 && !double.IsNaN(_state._itemLocations[19]))
            {
            ...
            if (nounIndex == 31 && _state._currentRoom != 3)
            {
            ...
            if (nounIndex == 31 && _state._currentRoom == 3 && double.IsNaN(_state._itemLocations[19]) && _state._items[19] == "AN OLD DIRTY DIME")
            {
                Print("A COBALT JEWEL. SLIDES DOWN THE CHUTE, HITS THE TRAY AND LANDS IN THE FLOOR. MAYBE THIS WASN'T WORTH YOUR DIME.");
                _state._itemLocations[19] = 0.5;
                _state._itemLocations[11] = 3;
                goto getCommand;
            }
            ...
            if (double.IsNaN(_state._itemLocations[19]) && _state._items[19] == "A SHINY QUARTER" && _state._currentRoom == 10 && nounIndex == 29)
            {
                ...
                _state._itemLocations[29] = double.NaN;
                _state._itemLocations[19] = 0.5;
                goto getCommand;
            }

            //1473 IFR=10ANDI(15)=0ANDN=15THENPRINT"YOU ALREADY HAVE THE GLUE.":GOTO80
            if (_state._currentRoom == 9 && double.IsNaN(_state._itemLocations[14]) && nounIndex == 14)
            {
            ...
            if (_state._currentRoom == 9 && _state._rooms[_state._currentRoom, 3] != "13")
            {
            ...
            if (_state._currentRoom == 9 && nounIndex == 14 && _state._itemLocations[14] == 0.5 && double.IsNaN(_state._itemLocations[19]))
            {
            ...
            if (_state._currentRoom == 9 && (nounIndex == 20 || nounIndex == 21) && double.IsNaN(_state._itemLocations[19]))
            {
            ...
            if (_state._currentRoom == 9)
            {
                if (!double.IsNaN(_state._itemLocations[19]))
                {
            ...
            if (_state._currentRoom == 9)
            {
                Print("YOU LOOK AND LOOK AND EVEN ASK THE CLERK TO HELP YOU BUT YOU JUST CAN'T FIND ANY {0} IN THIS STORE.", noun);
                goto getCommand;
            }
            ...
            if (_state._currentRoom == 9 && _state.jailFlag == 1)
            {
        ...
        processGive:        // 1490
            ...
            if (nounIndex == 29 && _state._currentRoom == 9 && _state._items[29] != "BROKEN BOTTLE" && double.IsNaN(_state._itemLocations[29]) && _state._rooms[9, 3] == "13")
            {
                Print("THE CLERK TAKES THE BOTTLE AND HAPPILY GIVES YOU A DIME.");
                _state._items[19] = "AN OLD DIRTY DIME";
                _state._itemLocations[29] = .8;
                _state._itemLocations[19] = double.NaN;
                goto getCommand;
            }
            ...
            if (nounIndex == 29 && _state._rooms[9, 3] == "13" && _state._currentRoom == 9 && _state._items[29] == "BROKEN BOTTLE")
            {
            ...
            if (_state._currentRoom == 10 && nounIndex == 2 && _state._rooms[10, 3] == "15")
            {
                ...
                _state._rooms[10, 3] = "0";
                _state._itemLocations[nounIndex] = .5;
                _state._itemLocations[25] = double.NaN;
                goto getCommand;
            }
            ...
            if (_state._currentRoom == 13 && nounIndex == 26 && _state._rooms[_state._currentRoom, 3] == "14")
            {
                Print("THE JAILER GRACIOUSLY TAKES THE BEER, DRINKS ALL SIX, AND PASSES OUT.");
                _state._itemLocations[26] = .7;
                _state._rooms[_state._currentRoom, 3] = "16";
                goto getCommand;
            }

            //1496 IFN=30ANDI(30)ANDR=1THENPRINT"THIS CLERK DOESN'T WANT THE BOTTLE.":GOTO80
            if (nounIndex == 29 && double.IsNaN(_state._itemLocations[29]) && _state._currentRoom == 0)
            {
            ...
            if (nounIndex == 29 && double.IsNaN(_state._itemLocations[29]) && (_state._currentRoom != 0 && _state._currentRoom != 9))
            {
        ...
        getKeys:            // 1530
            ...
            if (_state._currentRoom == 13 && _state._rooms[_state._currentRoom, 3] == "14")
            {
            ...
            if (_state._currentRoom == 13 && _state._rooms[_state._currentRoom, 3] == "16")
            {
                Print("YOU REACH THROUGH THE BARS AND GRAB HIS KEYS (THIS IS ANOTHER FELONY, OF COURSE.)");
                _state._itemLocations[28] = 0;
                _state._rooms[_state._currentRoom, 3] = "17";
                goto getCommand;
            }

            //1540 IFI(29)=RTHENI(29)=0: PRINT"TAKEN.":GOTO80
            if (_state._itemLocations[28] == _state._currentRoom)
            {
                _state._itemLocations[28] = 0;
                Print("Taken.");
                goto getCommand;
        ...
        processGlue:        // 1550
            ...
            if ((nounIndex == 5 || nounIndex == 29) && _state._items[nounIndex] == "BROKEN BOTTLE" && double.IsNaN(_state._itemLocations[nounIndex]) && double.IsNaN(_state._itemLocations[14]))
            {
                Print("YOU SUCCESSFULLY MENDED THE BROKEN BOTTLE.");
                _state._items[nounIndex] = "MENDED BOTTLE";
                goto getCommand;
            }
        ...
        processWear:        // 1600
            ...
            if (nounIndex == 6 && double.IsNaN(_state._itemLocations[nounIndex]) && _state.clothingFlag == 0)
            {
                Print("THE CLOTHES FIT NICELY.  YOU LOOK RATHER DAPPER.");
                _state.clothingFlag = 1;
                goto getCommand;
            }
            ...
            if (nounIndex == 6 && double.IsNaN(_state._itemLocations[nounIndex]) && _state.clothingFlag == 1)
            {
        ...
        processKill:        // 1640
            ...
            if (nounIndex == 33 && _state._currentRoom == 4)
            {
            ...
            if ((nounIndex == 34 && _state._currentRoom == 10) || (nounIndex == 35 && (_state._currentRoom == 0 || _state._currentRoom == 9)))
            {
        ...
        processReturn:      // 1660
            ...
            if (nounIndex == 29 && _state._currentRoom == 9 && _state._items[nounIndex] != "BROKEN BOTTLE" && double.IsNaN(_state._itemLocations[nounIndex]))
            {
                Print("THE CLERK TAKES THE BOTTLE AND HAPPILY GIVES YOU A DIME.");
                _state._items[19] = "AN OLD DIRTY DIME";
                _state._itemLocations[29] = .8;        // hides the sun-drop bottle from the game
                _state._itemLocations[19] = double.NaN;
                goto getCommand;
            }
            ...
            if (nounIndex == 29 && _state._currentRoom == 9 && _state._items[nounIndex] == "BROKEN BOTTLE")
            {
                Print("SORRY SIR, WE DON'T ACCEPT BROKEN BOTTLES FOR DEPOSIT, PERHAPS  YOU SHOULD MEND IT.");
                goto getCommand;
            }
        ...
        getBottle:          // 1700
            ...
            if (_state._currentRoom == 4 && _state._itemLocations[29] == 4 && _state._rooms[4, 3] == "7")
            {
        ...
        openWall:           // 1704
            ...
            if (bottleChoice == "WINE" && _state._rooms[4, 3] == "7")
            {
                Print("A PORTION OF THE SOUTH WALL SLIDES FROM VIEW.");
                _state._rooms[4, 3] = "8";
                goto getCommand;
            ...
            if (bottleChoice == "WINE" && _state._rooms[4, 3] == "8")
            {
        ...
        getUnambiguousBottle:         // 1719
            ...
            if (_state._currentRoom == 4 && _state._rooms[4, 3] == "8" && _state._itemLocations[29] == _state._currentRoom) goto getSunDrop;

            //1720 IFR=5THENW$="WINE":GOTO1704
            if (_state._currentRoom == 4)
            {
                bottleChoice = "WINE";
                goto openWall;
            }
        ...
        getSunDrop:         // 1722
            ...
            if (_state._itemLocations[29] == _state._currentRoom)
            {
                _state._itemLocations[29] = double.NaN;
                Print("TAKEN.");
                goto getCommand;
        ...
        processBreak:       // 1750
            ...
            {
                Print("THE BOTTLE BREAKS IN HALF REVEALING AN ORANGE JEWEL, WHICH YOU PROCEED TO TAKE.");
                _state._itemLocations[16] = double.NaN;        // The orange jewel goes in your inventory
                _state._items[29] = "BROKEN BOTTLE";
                _state._itemLocations[29] = double.NaN;
        ...
        winnerWinner:
            ...
            Print(_state._rooms[15, 0] + _state._rooms[15, 1]);
            Print();
        ...
        {
            _state._rooms[0,0]="YOU ARE IN A HOTEL LOBBY. THERE IS A NEWSPAPER STAND BESIDE AN OLD MUSTY COUCH ALONG THE WEST WALL. THERE ARE TWO THROW PILLOWS ON THE COUCH. OPPOSITE ALL THIS ON THE WEST WALL IS A RECEPTION DESK WITH A SMILING CLERK STANDING BEHIND IT. A FLIGHT OF STAIRS LEADS UP AND DOWN. THERE IS AN EXIT TO THE SOUTH AND THE STREET LIES TO THE EAST.";
            _state._rooms[0,1]="";
            _state._rooms[1,0]="THIS IS THE ROOM YOU WERE SUPPOSED TO SLEEP IN LAST NIGHT. YOUR BED IS IN A SHAMBLES. IT LOOKS LIKE THERE MIGHT HAVE BEEN A PARTY NEARBY LAST NIGHT. BY THE WAY, THERE IS A DOORWAY TO THE WEST AND STAIRS LEADING DOWN.";
            _state._rooms[2,0]="NO WONDER YOU DIDN'T SLEEP IN YOUR ROOM LAST NIGHT. NO ONE COULD HAVE LIVED THROUGH THE PARTY IN THIS ROOM MUCH LESS SLEPT THROUGH IT. THERE ARE NUMEROUS PEOPLE LYING AROUND THE ROOM IN VARIOUS STATES OF UNDRESS AND CONSCIOUSNESS. A BUSTED T.V. AND A DEMOLISHED MIRROR ARE AMONG THE RECOGNIZABLE REMAINS OF THIS ROOM.";
            _state._rooms[2,1]=" ";
            _state._rooms[3,0]="THIS ROOM SIMPLY ASTOUNDS YOU. THERE ARE LARGE TROPICAL PLANTS IN EVERY CORNER AND A BLUE HAZE FILLS THE AIR. YOU BEGIN TO LAUGH AND YOU GET THE MUNCHIES. A SINGLE EXIT LIES TO THE NORTH. THERE IS A MACHINE HERE THAT CLOSELY RESEMBLES A BAUBLE MACHINE.";
            _state._rooms[3,1]="";
            _state._rooms[4,0]="THIS IS THE CELLAR. THERE ARE RACKS OF WINE LINING THE WALLS--IT'S A WINE CELLAR! A MUSTY SMELL PERMEATES THE ROOM AND A SMALL RAT EYES YOU SUSPICIOUSLY. A STEEP FLIGHT OF STAIRS LEADS UPWARDS.";
            _state._rooms[5,0]="YOU EMERGE FROM THE HOLE INTO A VERY ANCIENT LOOKING ROOM. BUT,THEN AGAIN, NOT MUCH COULD BE WORSE THAN THAT CELLAR. SOME KIND OF EVIL GENIUS MUST HAVE USED THIS FOR HIS LAB. THOUSANDS OF CHEMICALS LINE A SHELF THAT RUNS ALONG ONE WALL. OBVIOUSLY, NO ONE HAS BEEN IN HERE FOR AGES AS AT LEAST TWO INCHES OF DUST IS ON THE FLOOR. ALL SORTS OF CONTRAPTIONS THAT YOU CAN ONLY GUESS WHAT THEY DO LIE SCATTERED ON THE FLOOR. OH WELL, THEY PROBABLY DIDN'T WORK ANYWAY.";
            _state._rooms[5,1]="";
            _state._rooms[5,2]="";
            _state._rooms[6,0]="YOU ARE OUT ON THE STREET. IN FACT, A SIGN SAYS YOU ARE 'DOWNTOWN'. TO THE EAST, OPEN DOORS LEAD INTO AN ARCADE. THE STREET IS SPARSLEY POPULATED BUT THE FEW HERE ARE DRIVING LIKE IDIOTS. (RED LIGHTS HAVE NO MEANING TO THESE PEOPLE.) THERE ARE TWO CHILDREN ON THE OPPOSITE SIDEWALK. YOUR HOTEL IS TO THE WEST. THE STREET CONTINUES NORTH AND SOUTH.";
            _state._rooms[6,1]="";
            _state._rooms[7,0]="IT SEEMS YOU HAVE WANDERED INTO AN ARCADE. ALL YOUR FAVORITE GAMES ARE HERE. SOME INCLUDE: ALCON, XEVIOUS, PINBOT, IKARI WARRIORS, AND MANY MORE. A PAY PHONE HANGS ON THE WALL.";
            _state._rooms[8,0]="YOU ARE IN THE STREET. A SIGN HERE SAYS 'UPTOWN'. THERE IS A JIM DANDY MARKET IS TO THE EAST. THE STREET CONTINUES TO THE NORTH AND SOUTH. THERE ARE MANY CARS HERE. YOU COUGH YOUR WAY THROUGH THE CARBON MONOXIDE.";
            _state._rooms[9,0]="THIS JIM DANDY'S IS JUST LIKE ANY OTHER CONVENIENCE MARKET. IT HAS EVERYTHING YOU'D EVER NEED AT OUTRAGEOUS PRICES. YOU NOTICE SOME ITEMS ARE ON SALE: RICE-A-RONI, 2 LITRE COKES, AND GLUE.";
            _state._rooms[10,0]="  YOU ARE STILL IN THE STREET. ANOTHER SIGN HERE SAYS 'MOTOWN'. JAMES BROWN MUSIC CAN BE HEARD FAINTLY IN THE BACKGROUND. A SUN-DROP MACHINE IS IN FRONT OF THE LOCAL JAIL WHICH IS TO THE EAST. EXITS LIE IN ALL FOUR DIRECTIONS. A MANHOLE IS IN THE STREET.";
            _state._rooms[10,1]="";
            _state._rooms[11,0]="THIS IS THE FRONT OFFICE OF THE LOCAL POLICE STATION. THE STREET IS TO THE WEST AND A DOOR LEADS NORTH. THERE ARE SOME EMPTY JAIL CELLS IN THE BACK.";
            _state._rooms[12,0]="YOU ARE IN A DARK ALLEY. THE OPPRESSIVENESS OF THIS PLACE DROWNS OUT THE MUSIC TO A MERE WHISPER. ALLEY CATS SQUALL AT YOU. THIS DOESN'T LOOK GOOD, YOU'D BETTER GET OUT OF HERE QUICK BEFORE YOU BECOME CAT FOOD.";
            _state._rooms[13,0]="YOU ARE IN A CELL. THE REPUGNANT SMELL OF THE TOILET OVERWHELMS YOU. THERE IS A LONE BENCH IN ONE CORNER AND RAUNCHY DRAWINGS (WITH CAPTIONS) ON THE WALL.";
            _state._rooms[14,0]="THIS IS THE EVIDENCE ROOM.";
            _state._rooms[15,0]="THIS IS THE TEMPLE OF ATTU-KOR. YOU ASK YOURSELF WHY NO ONE HAS EVER DISCOVERED IT BEFORE. AFTER ALL, IT'S ONLY UNDER THE STREET. THE WALLS ARE OF SOLID GOLD AND THE FLOOR IS INLAID WITH DIAMONDS. OTHER THAN THAT, THIS PLACE IS NO BIG DEAL. A LARGE THRONE IS AT ONE END. THE ROOM IS ILLUMINATED BUT THERE IS NO APPARENT LIGHT SOURCE.";
            _state._rooms[15,1]="";

            for (int i = 0; i < _state._itemLocations.Length; i++)
            {
                _state._itemLocations[i] = .5;
            }
            ...
            _state._items[0] = "BOOK"; _state._itemLocations[0] = 4;
            _state._items[1] = "CIGARETTE (BURNING)"; _state._itemLocations[1] = double.NaN;
            _state._items[2] = "A STICK OF BOLOGNA"; _state._itemLocations[2] = 1;
            _state._items[3] = "A NEWSPAPER";_state._itemLocations[3]=0.1;
            _state._items[4] = "A POSTCARD OF LA PAZ, BOLIVIA"; _state._itemLocations[4] = 0.1;
            _state._items[6] = "A HAT, GLASSES, AND A COAT (CLOTHES)";_state._itemLocations[6]=2;
            _state._items[7] = "AN INSTANT CAMERA";_state._itemLocations[7]=1;
            _state._items[10] = "A CLEAR JEWEL"; _state._itemLocations[10] = 5;
            _state._items[11] = "A COBALT JEWEL";
            _state._items[14] = "A BOTTLE OF GLUE";
            _state._items[16] = "AN ORANGE JEWEL";
            _state._items[18] = "A SPOOL OF STRING"; _state._itemLocations[18] = 38;
            _state._items[22] = "A RUSTY CROWBAR";_state._itemLocations[22]=14;
            _state._items[24] = "PLAYDOUGH-LIKE SUBSTANCE"; _state._itemLocations[24]=14;
            _state._items[25] = "GOLDEN AMULET";
            _state._items[26] = "A SIX-PACK OF COORS LIGHT";
            _state._items[28] = "SOME KEYS";
            _state._items[29] = "SUN-DROP";

            _state.status[0] = " ";
            _state.status[1] = "THE DOOR IS OPEN";
            _state.status[2] = "THE DOOR IS CLOSED";
            _state.status[3] = "THE STAND CONTAINS A NEWSPAPER AND A POSTCARD";
            _state.status[4] = "THE STAND CONTAINS A NEWSPAPER";
            _state.status[5] = "THE STAND CONTAINS A LONELY LITTLE POSTCARD";
            _state.status[6] = "THE STAND HAS BEEN LOOTED.  IT IS BARE";
            _state.status[7] = "A WINE RACK HANGS ON THE SOUTH WALL. A LONLEY BOTTLE OF OLD WINE SITS IN THE RACK.";
            _state.status[8] = "A LARGE HOLE LEADS SOUTH.";
            _state.status[9] = "THE CHILDREN ARE THROWING A FRISBEE. YOU CAN'T BE SURE FROM HERE, BUT THE FRISBEE APPEARS TO BE A WHAM-O. ";
            _state.status[10] = "THE CHILDREN LOOK AS IF THEY JUST LOST THEIR FRISBEE. THEY ARE CRYING.";
            _state.status[11] = "YOU NOTICE WORKMEN CAREFULLY INSTALLING A NEW WINDOW AT JIM DANDY MARKET. YOU WONDER WHAT MIGHT HAVE BROKEN IT.";
            _state.status[12] = "SHARDS OF GLASS LIE EVERYWHERE. THE WINDOW OF JIM DANDY ALSO SEEMS TO BE BROKEN. A SHREDDED FRISBEE LIES AMONG THE SHARDS.";
            _state.status[13] = "THE CLERK IS SMILING AND ASKS IF SHE CAN BE OF ANY ASSISTANCE.";
            _state.status[14] = "THE JAILER IS STANDING OUTSIDE THE CELL. HIS KEYS HANG ON HIS BELT.";
            _state.status[15] = "THERE IS AN OLD MAN HERE WITH A FUNNY HAT AND DIRTY CLOTHES.";
            _state.status[16] = "THE JAILER IS SPRAWLED OUT DRUNK ON THE FLOOR. HIS KEYS STILL HANG ON HIS BELT.";
            _state.status[17] = "THERE IS A DRUNK JAILER HERE.";
            ...
            _state._rooms[4,3]="7";
            _state._rooms[6,3]="9";
            _state._rooms[8,3]="11";
            _state._rooms[9,3]="13";
            _state._rooms[10,3]="15";
            _state._rooms[13,3]="14";
            _state._rooms[11,3]="2";

            // Sets the door direction.  Corresponds to entries in the _shortcuts array.
            _state._rooms[1, 4] = "3";
            _state._rooms[2, 4] = "2";
            _state._rooms[4, 4] = "1";
            _state._rooms[11, 4] = "0";

            // Since arrays are now 0 based, had to replace 0, indicating 'not an exit' with 255.
            _state._exits[0]= Ascii.Chr(255)+Ascii.Chr(3)+Ascii.Chr(6)+Ascii.Chr(255)+Ascii.Chr(1)+Ascii.Chr(4);
            _state._exits[1]= Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(2)+Ascii.Chr(255)+Ascii.Chr(0);
            _state._exits[2]=Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(1)+Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(255);
            _state._exits[3]=Ascii.Chr(0)+Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(255);
            _state._exits[4]=Ascii.Chr(255)+Ascii.Chr(5)+Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(0)+Ascii.Chr(255);
            _state._exits[5]=Ascii.Chr(4)+Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(255);
            _state._exits[6]=Ascii.Chr(8)+Ascii.Chr(255)+Ascii.Chr(7)+Ascii.Chr(0)+Ascii.Chr(255)+Ascii.Chr(255);
            _state._exits[7]=Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(6)+Ascii.Chr(255)+Ascii.Chr(255);
            _state._exits[8]=Ascii.Chr(10)+Ascii.Chr(6)+Ascii.Chr(9)+Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(255);
            _state._exits[9]=Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(8)+Ascii.Chr(255)+Ascii.Chr(255);
            _state._exits[10]=Ascii.Chr(12)+Ascii.Chr(8)+Ascii.Chr(11)+Ascii.Chr(12)+Ascii.Chr(255)+Ascii.Chr(15);
            _state._exits[11]=Ascii.Chr(14)+Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(10)+Ascii.Chr(255)+Ascii.Chr(255);
            _state._exits[12]=Ascii.Chr(255)+Ascii.Chr(10)+Ascii.Chr(10)+Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(255);
            _state._exits[13]=Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(11)+Ascii.Chr(255)+Ascii.Chr(255);
            _state._exits[14]=Ascii.Chr(255)+Ascii.Chr(11)+Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(255);
            _state._exits[15]=Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(255)+Ascii.Chr(255);

            _state._currentRoom = 0;
        }
