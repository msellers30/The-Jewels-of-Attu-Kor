...
#region get nouns
        ...
        internal void Initialize()
        {
            ...
            _rooms[2,0]="NO WONDER YOU DIDN'T SLEEP IN YOUR ROOM LAST NIGHT. NO ONE COULD HAVE LIVED THROUGH THE PARTY IN THIS ROOM MUCH LESS SLEPT THROUGH IT. THERE ARE NUMEROUS PEOPLE LYING AROUND THE ROOM IN VARIOUS STATES OF UNDRESS AND CONSCIOUSNESS. A BUSTED T.V. AND A DEMOLISHED MIRROR ARE AMONG THE RECOGNIZABLE REMAINS OF THIS ROOM.";
            _rooms[2,1]=" ";
            _rooms[3,0]="THIS ROOM SIMPLY ASTOUNDS YOU. THERE ARE LARGE TROPICAL PLANTS IN EVERY CORNER AND A BLUE HAZE FILLS THE AIR. YOU BEGIN TO LAUGH AND YOU GET THE MUNCHIES. A SINGLE EXIT LIES TO THE NORTH. THERE IS A MACHINE HERE THAT CLOSELY RESEMBLES A BAUBLE MACHINE.";
            _rooms[3,1]="";
            ...
            _rooms[10,0]="  YOU ARE STILL IN THE STREET. ANOTHER SIGN HERE SAYS 'MOTOWN'. JAMES BROWN MUSIC CAN BE HEARD FAINTLY IN THE BACKGROUND. A SUN-DROP MACHINE IS IN FRONT OF THE LOCAL JAIL WHICH IS TO THE EAST. EXITS LIE IN ALL FOUR DIRECTIONS. A MANHOLE IS IN THE STREET.";
            _rooms[10,1]="";
